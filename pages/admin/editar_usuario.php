        ...
        if (isset($_POST['criar_usuario'])) {
                ...
                if (count($erro) > 0) {
                        ...
                        if (empty($password) || $password === "") {
                                ...
                                SET
                                nome = '$name', email = '$email', data_cadastro = NOW(), creditos = '$credits', isAdmin = '$users' 
                                WHERE id = '$user_id'
                                ";
                        } else {
                                ...
                                $sql_query = "UPDATE usuarios 
                                SET
                                nome = '$name', email = '$email', senha = '$password_hash', data_cadastro = NOW(), creditos = '$credits', isAdmin = '$users' 
                                WHERE id = '$user_id'
                                ";
                        }
                        ...
                        if ($sql_exec) {
                                $sucess = "Usuário editado com sucesso! <a class='color_primary' href='index.php?p=gerenciar_usuarios&admin=true'> Retornar ao cadastro de usuários </a>";
                                return [
                                        "status" => 201,
                                        "success" => $sucess
                                ];
        ...
        <div class="row align-items-end">
                <div class="col-lg-8">
                        <div class="page-header-title">
                                ...
                                <div class="d-inline">
                                        <h4>Edite seu usuário</h4>
                                        <span>Edite as informaçõs e clique em salvar para alterar o usuário</span>
                                </div>
                        </div>
                </div>
        </div>
        ...
        <div class="card">
                <form class="p-4" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="creditos" placeholder="R$ 00,00" name="creditos" value="<?= $user_search['creditos'] ?>">
                        </div>
                        <div class="form-group">
